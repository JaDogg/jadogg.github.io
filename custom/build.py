...
def main():
    ...
    docbox.conv(["--export", "-r", "--no-number", "-o", "exports/index.md", "--posts=posts"], root=path)
    docbox.conv(["--export", "--all-headers-in-toc", "--input", "system_design", "-o", "exports/sdt.md"], root=path)
